     ...
     while (TRUE) 
      {
	    ...
	    if (ChildSock < 0) 
            ...
            if ((memcmp(buffer, BEGIN_HANDSHAKE_STRING, strlen(BEGIN_HANDSHAKE_STRING)) != 0) || (memcmp(buffer + (x - strlen(END_HANDSHAKE_STRING)), END_HANDSHAKE_STRING, strlen(END_HANDSHAKE_STRING)) != 0))
	     {
